...
function setup() {
  ...
  ground = createSprite(200,displayHeight-390,400,20);
  ...
  invisibleGround = createSprite(200,displayHeight-360,400,10);
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    var obstacle = createSprite(600,displayHeight-400,10,40);
    //obstacle.debug = true;
